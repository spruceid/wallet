...
#
# This script is no longer actively maintained, it is best to consult Android
# and Flutter documentation, in addition to the README.
#

## DEPENDENCIES
sudo apt update
sudo apt upgrade
sudo apt install -y git lib32z1 libssl-dev pkg-config build-essential curl cmake openjdk-17-jdk zip unzip
