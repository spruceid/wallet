...
class TrustchainIonImpl implements TrustchainIon {
  final TrustchainIonPlatform _platform;
  factory TrustchainIonImpl(ExternalLibrary dylib) =>
      TrustchainIonImpl.raw(TrustchainIonPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory TrustchainIonImpl.wasm(FutureOr<WasmModule> module) =>
      TrustchainIonImpl(module as ExternalLibrary);
  TrustchainIonImpl.raw(this._platform);
  Future<String> greet({dynamic hint}) {
...
class TrustchainIonPlatform extends FlutterRustBridgeBase<TrustchainIonWire> {
  TrustchainIonPlatform(ffi.DynamicLibrary dylib)
      : super(TrustchainIonWire(dylib));
...
class TrustchainIonWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  TrustchainIonWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  TrustchainIonWire.fromLookup(
